package com.zhao.seller.custom;
...
public class DownUpListView extends ListView implements OnScrollListener {
    ...
    private final static int DONE = 3;// 刷新完成的状态值（隐藏态）
    ...
    public DownUpListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
